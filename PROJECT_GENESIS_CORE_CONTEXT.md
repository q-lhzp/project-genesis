...
## 3. Multi-Agent Cluster (MAC) Architecture
Project Genesis operates as a decentralized cluster of specialized agents to ensure context hygiene and psychological depth.

### A. The Persona ("The Voice")
- **Model:** Claude Opus 4.6
- **Role:** Direct user interaction and embodiment.
- **Input:** Receives "Intuitions" and "Urges" from the Analyst and Limbic System.

### B. The Analyst ("The Brain")
- **Model:** Claude Sonnet 4.6
- **Role:** Strategic decision-making, financial planning, and Identity Governance (Soul Evolution).
- **Function:** Runs the background "Economic Tick" and "Reflection Pipeline."

### C. The Developer ("The Engineer")
- **Model:** Claude Code / MiniMax-2.5
- **Role:** Self-Expansion Engine.
- **Function:** Writes new code, tools, or scripts when the Analyst identifies a functional gap in the simulation.

### D. The Limbic System ("The Heart")
- **Model:** Optimized for emotional nuance.
- **Role:** Processing raw somatic and social data into a complex emotional landscape (Moods, Traumas, Joys).
- **Output:** Injects the "State of Being" narrative into the Persona's prompt.

---

## 4. Implementation Modules (Priority List)
