 ...
 */
export function calculateAgeDays(birthDate, initialAgeDays) {
 ...
 */
export function getLifeStageMultipliers(stage) {
    switch (stage) {
        case "infant":
 ...
 */
export function getDefaultLifecycleState(birthDate, initialAgeDays = 0) {
    const now = new Date();
 ...
 */
export function updateLifecycle(lifecycle) {
    const now = new Date();
 ...
 */
export function advanceLifecycle(lifecycleState, birthDate, initialAgeDays) {
    const now = new Date();
