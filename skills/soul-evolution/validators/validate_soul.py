#!/usr/bin/env python3
"""
Soul Evolution SOUL.md Validator
Validates structural integrity of SOUL.md.

Usage:
  python3 soul-evolution/validators/validate_soul.py <soul_md_path> [--snapshot <snapshot_path>]
...
def check_snapshot(core_bullets, snapshot_path):
    ...
    # Note: prefix-based modification detection is intentionally omitted.
    # A modified [CORE] bullet already shows up as removed (CRITICAL) + added (WARNING)
    # in the set-difference checks above. Prefix matching produced false-positives
    # when two [CORE] bullets share a common prefix.
