#!/usr/bin/env python3
"""
Soul Evolution State Validator
Validates memory/soul-state.json and reconciles counters against actual files.

Usage:
  python3 soul-evolution/validators/validate_state.py <state_json> [--memory-dir memory] [--proposals-dir memory/proposals]
