...
export default {
  ...
  register(api: OpenClawPluginApi) {
    // ---------------------------------------------------------------------------
    // Synchronous Hook Registration (Phase 52 - SDK Compatibility)
    // ---------------------------------------------------------------------------
    ...
    const paths: SimulationPaths = {
      ...
      portraits: resolvePath(ws, "memory", "reality", "portraits"),
    ...
    // Register Tools synchronously during register phase
